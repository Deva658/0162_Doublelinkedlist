...
public:
    ...
    void addNode()
    {
        ...
        cin >> nim;
                ...
                // step 1: aloicate memory for new node
        Node *newNode = new Node();

        // step 2: assign value to the data field 
        newNode->noMhs = nim;

        // step 3: insert at begibning if list is empty or nim is smallest
        ...
        // step 9: insert bertween current and currentr->next
    ...
    void traverse()
    {
        ...
        cout << "\nRecords in ascending prder of roll number are:\n";
        int i = 0;
